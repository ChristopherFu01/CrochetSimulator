...
def create_stitch_mesh(stitch):
    ...
    # Rotate cylinder to follow direction
    obj.rotation_euler = stitch["direction"].to_track_quat("Z", "Y").to_euler()
...
print("CrochetPARADE demo complete.")